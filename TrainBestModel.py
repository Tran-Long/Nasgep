"""
Be aware NUM_CHANNELS == 64 in Configs.py
"""
...
normal_adf_pop = ADFPopulation(ADF_HEAD_LEN, ADF_TAIL_LEN, for_reduction=False, pop_size=INIT_SIZE_ADF_POP,
                               max_size=MAX_SIZE_ADF_POP)
reduction_adf_pop = ADFPopulation(ADF_HEAD_LEN, ADF_TAIL_LEN, for_reduction=True, pop_size=INIT_SIZE_ADF_POP,
                                  max_size=MAX_SIZE_ADF_POP)
...
"""Best model from searching"""
n_cell1 = ['sum', 'point_1x1', 'sum', 'cat', 'sum', 'sum', 'cat', 'sum', 'dep_7x1', 0, 0, 'dep_3x3', 'sep_5x3', 'sum',
           0, 'isep_5x3', 0, 0, 'isep_1x7', 'isep_3x3', 'isep_7x1', 0, 0, 0, 0]
n_cell2 = ['sum', 'point_1x1', 'sum', 'cat', 'sum', 'sum', 'cat', 'sum', 'dep_7x1', 0, 1, 'dep_3x3', 'sep_5x3', 'sum',
           1, 'isep_5x3', 0, 0, 'isep_1x7', 'isep_3x3', 'isep_7x1', 1, 0, 1, 0]
n_cell3 = ['sum', 'point_1x1', 'sum', 'cat', 'sum', 'sum', 'cat', 'sum', 'dep_7x1', 2, 1, 'dep_3x3', 'sep_5x3', 'sum',
           2, 'isep_5x3', 1, 1, 'isep_1x7', 'isep_3x3', 'isep_7x1', 0, 1, 0, 2]
r_cell = ['point_1x1', 'cat', 'cat', 'cat', 'cat', 'sep_3x5', 'sum', 'dep_5x5', 'sum', 'isep_1x7', 'isep_5x5',
          'sep_7x1', 'pwbr_1x1', 'pwbr_1x1', 'dep_3x3', 'pwbr_1x1', 'isep_5x5', 'isep_7x1', 'pwbr_1x1', 0, 0,
          'pwbr_1x1', 3, 'isep_7x1', 'pwbr_1x1', 1, 1, 'pwbr_1x1', 0, 1]

best_genotypes = [[n_cell1, n_cell2, n_cell3], r_cell]
# TODO: add models genotype [[n_cell1, n_cell2, n_cell3], r_cell]
model = Model(normal_adf_pop, reduction_cell_pop, best_cell_genotypes=best_genotypes)
