...
class ModelPopulation:
    def __init__(self, pop_size, n, adf_population, cell_population, for_dataset = "cifar-10"):
        self.nonce = pop_size
        self.n = n
        ...
        for i in range(pop_size):
            ...
            self.models_dict[model_id] = Model(adf_population, cell_population, n, for_dataset = for_dataset)
    ...
    def test_population(self, test_loader, pop):
        for (model_id, model) in pop.items():
            ...
            print("Prev fitness = %.2f" % model.fitness, end = " ")
